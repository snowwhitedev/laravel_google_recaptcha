    ...
    <div>
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href=""><span>Authors</span></a></li>
                <li class="breadcrumb-item"><a href="{{ $author->url() }}"><span>{{ $author->name }}</span></a></li>
            </ol>
            <div class="row">
                <div class="col-md-12" style="margin-top: 2rem;">
                    <h2>Author: {{ $author->name }}</h2>
                    <p>
                        This page shows all Blog posts written by "{{ $author->name }}".
                    </p>
                    <br>
