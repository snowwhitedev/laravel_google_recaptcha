    ...
    <div>
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href=""><span>Tags</span></a></li>
                <li class="breadcrumb-item"><a href="{{ $tag->url() }}"><span>{{ $tag->title }}</span></a></li>
            </ol>
            <div class="row">
                <div class="col-md-12" style="margin-top: 2rem;">
                    <h2>Tag: {{ $tag->title }}</h2>
                    <p>
                        This page shows all Blog posts we've written that were tagged with "{{ $tag->title }}".
                    </p>
                    <br>
